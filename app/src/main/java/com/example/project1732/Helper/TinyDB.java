...
public class TinyDB {
    ...
    public void putListOrderObject(String key, ArrayList<Order> playerList) {
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for (Order player : playerList) {
    ...
    // Este codigo foi criado para implementar historico de pedidos
    public <T> ArrayList<T> getListObject(String key, Class<T> classOfT) {
        ...
        for (String objString : objStrings) {
            T obj = gson.fromJson(objString, classOfT);
            objectList.add(obj);
        }
        return objectList;
    }

    public <T> void putListObjectN(String key, ArrayList<T> objectList) {
        Gson gson = new Gson();
